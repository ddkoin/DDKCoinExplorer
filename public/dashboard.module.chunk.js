...
/***/ "../../../../../src/app/dashboards/dashboard-components/project-counter/data.json":
...
/***/ "../../../../../src/app/dashboards/dashboard-components/project-counter/project-counter.component.html":
/***/ (function(module, exports) {

module.exports = "<div class=\"row\">\n    <div class=\"col-lg-12\">\n        <div class=\"row\">\n            <div class=\"col-lg-6\">\n                <div class=\"card top-info\">\n                    <div class=\"card-body\">\n                        <div class=\"d-flex no-block\">\n                            <div class=\"m-r-20 align-self-center\">\n                                <span class=\"lstick m-r-20\"></span>\n                                <img src=\"assets/images/icon/income.png\" alt=\"Income\" />\n                            </div>\n                            <div class=\"align-self-center\">\n                                <h6 class=\"text-muted m-t-10 m-b-0\">LAST BLOCK</h6>\n                                <h2 class=\"m-t-0\">{{height}}</h2>\n                            </div>\n                        </div>\n                    </div>\n                </div>\n            </div>\n            <div class=\"col-lg-6\">\n                <div class=\"card top-info\">\n                    <div class=\"card-body\">\n                        <div class=\"d-flex no-block\">\n                            <div class=\"m-r-20 align-self-center\">\n                                <span class=\"lstick m-r-20\"></span>\n                                <img src=\"assets/images/icon/expense.png\" alt=\"Income\" />\n                            </div>\n                            <div class=\"align-self-center\">\n                                <h6 class=\"text-muted m-t-10 m-b-0\">TRANSACTIONS</h6>\n                                <h2 class=\"m-t-0\">{{transactionLength}}</h2>\n                            </div>\n                        </div>\n                    </div>\n                </div>\n            </div>\n\n\n\n\n\n\n\n\n\n        </div>\n    </div>\n    <div class=\"col-md-6\">\n        <div class=\"card\">\n            <div class=\"card-body\">\n                <div class=\"d-flex flex-wrap m-b-15\">\n                   \n                    <div class=\"mx-auto\">\n                        <ul class=\"list-inline m-b-0\">\n                            <li>\n                                <h6 class=\"text-muted text-primary m-b-0\">Last 14 Day's Transaction Volume Of DDKOIN Core Network</h6>\n                            </li>\n                        </ul>\n                    </div>\n                </div>\n                <div style=\"height:200px;\">\n                    <canvas baseChart [datasets]=\"balanceLineChartData\" [labels]=\"lineChartLabels\" [options]=\"lineChartOptions\" [colors]=\"lineChartColors\"\n                        [legend]=\"lineChartLegend\" [chartType]=\"lineChartType\"> </canvas>\n                </div>\n            </div>\n        </div>\n    </div>\n    <div class=\"col-md-6\">\n        <div class=\"card\">\n            <div class=\"card-body\">\n                <div class=\"d-flex flex-wrap m-b-15\">\n                   \n                    <div class=\"mx-auto\">\n                        <ul class=\"list-inline m-b-0\">\n                            <li>\n                                <h6 class=\"text-muted text-primary m-b-0\">Last 14 Day's Transactions History Of DDKOIN Network</h6>\n                            </li>\n                        </ul>\n                    </div>\n                </div>\n                <div style=\"height:200px;\">\n                    <canvas baseChart [datasets]=\"trsLineChartData\" [labels]=\"lineChartLabels\" [options]=\"lineChartOptions\" [colors]=\"lineChartColors\"\n                        [legend]=\"lineChartLegend\" [chartType]=\"lineChartType\"> </canvas>\n                </div>\n            </div>\n        </div>\n    </div>\n</div>\n"
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ProjectCounterComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__shared_services_allBlock_service__ = __webpack_require__("../../../../../src/app/shared/services/allBlock.service.ts");
...
var data = __webpack_require__("../../../../../src/app/dashboards/dashboard-components/project-counter/data.json");


//import { transactionsHistoryService } from '../../../shared/services/transactionsHistory.service';
var ProjectCounterComponent = (function () {
    function ProjectCounterComponent(allTx, allBx) {
        this.allTx = allTx;
        this.allBx = allBx;
        this.height = [];
        this.transactionHistory = [];
        this.transactionLength = [];
        this.trsLineChartData = [
            { data: [], label: 'Transactions ' }
        ];
        this.balanceLineChartData = [
            { data: [], label: 'Volume ' }
        ];
    ...
    ProjectCounterComponent.prototype.allBlockList = function () {
        var _this = this;
        this.allBx.getAllBlocks(25, 0).subscribe(function (resp) {
            if (resp.success) {
                _this.height = resp.blocks[0].height;
            }
        }, function (error) {
            console.log(error);
        });
    };
    ProjectCounterComponent.prototype.allTransactionsList = function () {
        var _this = this;
        this.allTx.getAllTransactions(25, 0).subscribe(function (resp) {
            if (resp.success) {
                _this.transactionLength = resp.count;
            }
        }, function (error) {
            console.log(error);
        });
    };
    ProjectCounterComponent.prototype.transactionsHistory = function () {
        var _this = this;
        this.allTx.getTransactionsHistory().subscribe(function (resp) {
            if (resp.success) {
                var data = [];
                var time = [];
                var balance = [];
                for (var i = 0; i < resp.trsData.length; i++) {
                ...
                _this.trsLineChartData[0].data = data;
                _this.balanceLineChartData[0].data = balance;
                _this.lineChartLabels = time;
            }
            else {
    ...
    ProjectCounterComponent.prototype.ngAfterViewInit = function () {
        this.allBlockList();
    ...
    ProjectCounterComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            ...
            template: __webpack_require__("../../../../../src/app/dashboards/dashboard-components/project-counter/project-counter.component.html")
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__shared_services_allTransactions_service__["a" /* allTransactionsService */], __WEBPACK_IMPORTED_MODULE_1__shared_services_allBlock_service__["a" /* allBlockService */]])
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__dashboard_dashboard_component__ = __webpack_require__("../../../../../src/app/dashboards/dashboard/dashboard.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ng_bootstrap_ng_bootstrap__ = __webpack_require__("../../../../@ng-bootstrap/ng-bootstrap/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__dashboard_routing__ = __webpack_require__("../../../../../src/app/dashboards/dashboard.routing.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_ng_chartist__ = __webpack_require__("../../../../ng-chartist/dist/ng-chartist.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_ng_chartist___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_8_ng_chartist__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_ng2_smart_table__ = __webpack_require__("../../../../ng2-smart-table/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__dashboard_components_project_counter_project_counter_component__ = __webpack_require__("../../../../../src/app/dashboards/dashboard-components/project-counter/project-counter.component.ts");
    ...
    DashboardModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_8_ng_chartist__["ChartistModule"],
            ...
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_10__dashboard_components_project_counter_project_counter_component__["a" /* ProjectCounterComponent */]
            ]
        })
    ], DashboardModule);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__dashboard_dashboard_component__ = __webpack_require__("../../../../../src/app/dashboards/dashboard/dashboard.component.ts");
...
module.exports = "<!-- Start Page Content -->\n<div class=\"row\">\n    <div class=\"col-12\">\n        <!-- You can find this in the dashboard-component -->\n        <project-counter></project-counter>\n    </div>\n</div>\n<!-- Ends Start Page Content -->\n<div class=\"row\">\n    <div class=\"col-md-6\">\n        <div class=\"card m-b-0\">\n            <div class=\"card-body heading-box b-b\">\n                <h4 class=\"card-title\">\n                    <span class=\"lstick\"></span>Blocks</h4>\n                <button type=\"button\" class=\"btn waves-effect btn-sm waves-light btn-outline-info pull-right view-all\" routerLink=\"/block\">View All</button>\n            </div>\n            <div *ngFor=\"let bxList of bxLists; let i = index;\">\n                <div class=\"p-20 b-b block-info-box d-flex\" *ngIf=\"i<5\">\n                    <div class=\"align-self-center pull-left\">\n                        <a class=\"m-b-0\" (click)=\"getBlockHeight(bxList.height,'height')\">Block {{bxList.height}}</a>\n                        \n                        <small>> {{bxList.timestamp | timeagofilter}}</small>\n                    </div>\n                    <div class=\"ml-left block-info-details pull-left\">\n                        <div class=\"overflow-h\">Generator By\n                            <a class=\"address-tag link-hover\" (click)=\"getGeneratorId(bxList.generatorId)\">{{bxList.generatorId}}</a>\n                            <p class=\"txns-time\">\n                                <a class=\"link-hover\">\n                                    <b>{{bxList.numberOfTransactions}} txns</b>\n                                </a> in 10 secs</p>\n                        </div>\n                    </div>\n                </div>\n            </div>\n        </div>\n    </div>\n    <div class=\"col-md-6\">\n        <div class=\"card m-b-0\">\n            <div class=\"card-body heading-box b-b\">\n                <h4 class=\"card-title\">\n                    <span class=\"lstick\"></span>Transactions</h4>\n                <button type=\"button\" class=\"btn waves-effect btn-sm waves-light btn-outline-info pull-right view-all\" routerLink=\"/transactions\">View All</button>\n            </div>\n            <div *ngFor=\"let txList of  txLists; let i = index;\">\n                <div class=\"profile-post color-one b-b\" *ngIf=\"i<5\">\n                    <span class=\"profile-post-numb\">\n                        <i class=\"fa fa-hdd-o\"></i>\n                    </span>\n                    <div class=\"profile-post-in\">\n                        <span class=\"heading-xs\">TX#\n                            <a class=\"hash-tag-frontpage link-hover\" title=\"Transaction Hash\" (click)=\"getTxId(txList.id,'transactionId')\">{{txList.id}}</a>\n                            <span class=\"pull-right\">{{txList.timestamp | timeagofilter }}</span>\n                        </span>\n                        <p>\n                            From <a class=\"address-tag link-hover\" (click)=\"getSenderId(txList.senderId)\">{{txList.senderId}}</a>\n                            <span *ngIf=\"txList.recipientId!==null\">\n                            To <a class=\"address-tag link-hover\" (click)=\"getSenderId(txList.recipientId)\">{{txList.recipientId}}</a></span>\n                        </p>\n                        <div *ngIf=\"txList.type === 8; else elseBlock\"><p>Amount {{txList.stakedAmount/100000000}} DDK</p></div>\n                        <ng-template #elseBlock><p>Amount {{txList.amount/100000000}} DDK</p></ng-template>\n                    </div>\n                </div>\n            </div>\n        </div>\n    </div>\n</div>\n"
...
var DashboardComponent = (function () {
    function DashboardComponent(router, allTx, allBx) {
        this.router = router;
        this.allTx = allTx;
        this.allBx = allBx;
        this.txLists = [];
    ...
    DashboardComponent.prototype.allTransactionsList = function () {
        var _this = this;
        this.allTx.getAllTransactions(25, 10).subscribe(function (resp) {
            if (resp.success) {
                _this.txLists = resp.transactions;
            }
        }, function (error) {
            console.log(error);
        });
    };
    DashboardComponent.prototype.allBlockList = function () {
        var _this = this;
        this.allBx.getAllBlocks(25, 0).subscribe(function (resp) {
            if (resp.success) {
                _this.bxLists = resp.blocks;
            }
        }, function (error) {
            console.log(error);
        });
    };
    DashboardComponent.prototype.getBlockHeight = function (height, name) {
        this.router.navigate(['/block-info', name, height]);
    };
    /* For Transactions Detail By ID */
    DashboardComponent.prototype.getTxId = function (id, name) {
        this.router.navigate(['/transaction-info', name, id]);
    };
    /* For Amount Detail By Address */
    DashboardComponent.prototype.getGeneratorId = function (generatorId) {
        this.router.navigate(['/user-info', generatorId]);
    };
    /* For Amount Detail By Address */
    DashboardComponent.prototype.getSenderId = function (senderId) {
    ...
    DashboardComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            template: __webpack_require__("../../../../../src/app/dashboards/dashboard/dashboard.component.html"),
            styles: [__webpack_require__("../../../../../src/app/dashboards/dashboard/dashboard.component.css")]
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_router__["f" /* Router */], __WEBPACK_IMPORTED_MODULE_2__shared_services_allTransactions_service__["a" /* allTransactionsService */], __WEBPACK_IMPORTED_MODULE_3__shared_services_allBlock_service__["a" /* allBlockService */]])
    ], DashboardComponent);
...
var CtrInput = (function () {
    ...
    CtrInput.ctorParameters = function () { return [
        ...
        { type: __WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* NgModel */], },
        { type: __WEBPACK_IMPORTED_MODULE_0__angular_core__["ElementRef"], },
    ]; };
